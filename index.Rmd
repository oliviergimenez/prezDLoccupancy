...
readr::read_csv2(here::here("prez/dat","perf_fastai.csv")) %>% 
  janitor::clean_names() %>%
  kbl() %>%
  kable_paper() %>%
  ...
  save_kable(here::here("prez/img", "perf1.png"),
             zoom = 5)
```
...
readr::read_csv2(here::here("prez/dat","perf_fastai.csv")) %>% 
  ...
  row_spec(14:16, bold = T) %>%
  column_spec(1, bold = TRUE) %>%
  save_kable(here::here("prez/img", "perf2.png"),
             zoom = 5)
```
...
readr::read_csv2(here::here("prez/dat","perf_fastai.csv")) %>% 
  ...
  row_spec(14:16, bold = T) %>%
  column_spec(1, bold = TRUE) %>%
  save_kable(here::here("prez/img", "perf.png"),
             zoom = 5)
```
...
```{r echo = FALSE, message = FALSE, warning = FALSE}
load(here::here("prez/dat/", "pixAinannot.RData"))
library(highcharter)
